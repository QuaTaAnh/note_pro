      ...
      <DropdownMenuContent className="w-[480px] p-0" align="end">
        ...
        <div className="p-4 border-b border-border">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="font-semibold text-base">Invite to Collaborate</h3>
          </div>
          <p className="text-sm text-muted-foreground mb-4">
            For easy collaboration with anyone, even without a Craft account
          </p>
          ...
          <div className="flex items-center gap-2">
            <Popover open={isPermissionOpen} onOpenChange={setIsPermissionOpen}>
              ...
              <PopoverContent className="w-[400px] p-2" align="start">
                ...
                <div className="border-t border-border mt-2 pt-2 px-3 pb-2">
                  <p className="text-xs text-muted-foreground mt-1">
                    Set your link to &ldquo;view&rdquo; or &ldquo;edit&rdquo;
                    for easy collaboration, no Craft account needed.
                  </p>
                </div>
              </PopoverContent>
            </Popover>
