...
export type GetUnreadNotificationsCountQuery = { __typename?: 'query_root', notifications_aggregate: { __typename?: 'notifications_aggregate', aggregate?: { __typename?: 'notifications_aggregate_fields', count: number } | null } };
 ...
 * });
 */
export function useGetUnreadNotificationsCountQuery(baseOptions: Apollo.QueryHookOptions<GetUnreadNotificationsCountQuery, GetUnreadNotificationsCountQueryVariables> & ({ variables: GetUnreadNotificationsCountQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
