...
export type GetScheduledTasksQuery = {
  __typename?: "query_root";
  tasks: Array<{
    __typename?: "tasks";
    id: string;
...
export type GetAllScheduledTasksQuery = {
  ...
  tasks: Array<{
    ...
    block?: {
      ...
      type: string;
      page_id?: string | null;
      page?: { __typename?: "blocks"; id: string; content?: any | null } | null;
    } | null;
  }>;
};
...
export type GetTodayTasksQuery = {
  __typename?: "query_root";
  tasks: Array<{
    __typename?: "tasks";
    id: string;
 ...
 * });
 */
export function useGetIncompleteTasksQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetIncompleteTasksQuery,
    GetIncompleteTasksQueryVariables
  > &
    (
      | { variables: GetIncompleteTasksQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  ...
  return Apollo.useQuery<
    GetIncompleteTasksQuery,
    GetIncompleteTasksQueryVariables
  >(GetIncompleteTasksDocument, options);
}
export function useGetIncompleteTasksLazyQuery(
...
export function useGetIncompleteTasksSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
...
export type GetIncompleteTasksQueryHookResult = ReturnType<
  typeof useGetIncompleteTasksQuery
>;
export type GetIncompleteTasksLazyQueryHookResult = ReturnType<
  typeof useGetIncompleteTasksLazyQuery
>;
export type GetIncompleteTasksSuspenseQueryHookResult = ReturnType<
  typeof useGetIncompleteTasksSuspenseQuery
>;
export type GetIncompleteTasksQueryResult = Apollo.QueryResult<
  GetIncompleteTasksQuery,
  GetIncompleteTasksQueryVariables
>;
 ...
 * });
 */
export function useGetScheduledTasksQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetScheduledTasksQuery,
    GetScheduledTasksQueryVariables
  > &
    (
      | { variables: GetScheduledTasksQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    GetScheduledTasksQuery,
    GetScheduledTasksQueryVariables
  >(GetScheduledTasksDocument, options);
}
export function useGetScheduledTasksLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetScheduledTasksQuery,
    GetScheduledTasksQueryVariables
  >,
...
export function useGetScheduledTasksSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        GetScheduledTasksQuery,
...
export type GetScheduledTasksQueryHookResult = ReturnType<
  typeof useGetScheduledTasksQuery
>;
export type GetScheduledTasksLazyQueryHookResult = ReturnType<
  typeof useGetScheduledTasksLazyQuery
>;
export type GetScheduledTasksSuspenseQueryHookResult = ReturnType<
  typeof useGetScheduledTasksSuspenseQuery
>;
export type GetScheduledTasksQueryResult = Apollo.QueryResult<
  GetScheduledTasksQuery,
  GetScheduledTasksQueryVariables
>;
export const GetAllScheduledTasksDocument = gql`
  query GetAllScheduledTasks($workspaceId: uuid!) {
    tasks(
      where: {
        block: { workspace_id: { _eq: $workspaceId } }
        schedule_date: { _is_null: false }
        status: { _neq: "completed" }
      }
      order_by: { schedule_date: asc }
 ...
 * });
 */
export function useGetTodayTasksQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetTodayTasksQuery,
    GetTodayTasksQueryVariables
  > &
    (
      | { variables: GetTodayTasksQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetTodayTasksQuery, GetTodayTasksQueryVariables>(
    GetTodayTasksDocument,
    options,
  );
}
export function useGetTodayTasksLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetTodayTasksQuery,
    GetTodayTasksQueryVariables
  >,
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<GetTodayTasksQuery, GetTodayTasksQueryVariables>(
    GetTodayTasksDocument,
    options,
  );
}
export function useGetTodayTasksSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        GetTodayTasksQuery,
  ...
  return Apollo.useSuspenseQuery<
    GetTodayTasksQuery,
    GetTodayTasksQueryVariables
  >(GetTodayTasksDocument, options);
}
export type GetTodayTasksQueryHookResult = ReturnType<
  typeof useGetTodayTasksQuery
>;
export type GetTodayTasksLazyQueryHookResult = ReturnType<
  typeof useGetTodayTasksLazyQuery
>;
export type GetTodayTasksSuspenseQueryHookResult = ReturnType<
  typeof useGetTodayTasksSuspenseQuery
>;
export type GetTodayTasksQueryResult = Apollo.QueryResult<
  GetTodayTasksQuery,
  GetTodayTasksQueryVariables
>;
...
export function useGetTodoTasksSuspenseQuery(
  ...
  const options =
    baseOptions === Apollo.skipToken
      ? baseOptions
      : { ...defaultOptions, ...baseOptions };
  return Apollo.useSuspenseQuery<GetTodoTasksQuery, GetTodoTasksQueryVariables>(
    GetTodoTasksDocument,
    options,
  );
}
